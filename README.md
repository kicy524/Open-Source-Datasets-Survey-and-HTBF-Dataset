...
### 西南交通大学复杂装备智能制造与工业软件团队智能运维课题组发布全球首个包含配套仿真模型的高速列车转向架故障（High-speed Train Bogie Fault, HTBF）数字孪生数据集。数据集中包含缩小比例的高速列车转向架故障模拟实验数据及其配套仿真模型，共计18种工况条件下的29类健康状态的多传感器数据speed Train Bogie Fault, HTBF）数字孪生数据集，并且可通过配套的仿真模型进行数据扩充、验证与分析。
## 1.实验平台介绍
...
![image](https://github.com/user-attachments/assets/6873a3bc-0fb5-460f-a0ea-005f84228f14)
### 图1 物理故障模拟试验台
...
![image](https://github.com/user-attachments/assets/7db08e6f-d4c1-4777-b68b-59920d281644)
### 图3 轴承\齿轮故障件图片
